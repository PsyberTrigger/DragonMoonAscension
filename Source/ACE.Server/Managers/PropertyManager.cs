    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<long>> DefaultLongProperties =
            DictOf(
                ...
                ("last_black_dragon_kill", new Property<long>(1, "Day of the month that the last Black Dragon died.")),
                ("last_blue_dragon_kill", new Property<long>(1, "Day of the month that the last Blue Dragon died.")),
                ("last_green_dragon_kill", new Property<long>(1, "Day of the month that the last Green Dragon died.")),
                ("last_bronze_dragon_kill", new Property<long>(1, "Day of the month that the last Bronze Dragon died.")),
                ("last_red_dragon_kill", new Property<long>(1, "Day of the month that the last Red Dragon died.")),
                ("last_gold_dragon_kill", new Property<long>(1, "Day of the month that the last Gold Dragon died.")),
